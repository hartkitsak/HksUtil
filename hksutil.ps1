...
$script:embeddedConfigs['meta'] = @{'version' = "3.0"; 'build' = ""}
$script:embeddedConfigs['themes'] = @{'light' = @{'windowBackground' = "#F4F8FC"; 'headerBackground' = "#FFFFFF"; 'headerBorder' = "#C4D9ED"; 'footerBackground' = "#FFFFFF"; 'footerBorder' = "#C4D9ED"; 'cardBackground' = "#FFFFFF"; 'cardForeground' = "#1A2733"; 'cardBorder' = "#BDD3E8"; 'accentColor' = "#4D9DE0"; 'accentHover' = "#3A87C8"; 'pageTitleColor' = "#1A2733"; 'categoryHeaderColor' = "#4D9DE0"; 'textMuted' = "#7A96AE"; 'textBoxBackground' = "#FFFFFF"; 'textBoxForeground' = "#1A2733"; 'textBoxBorder' = "#BDD3E8"; 'dangerColor' = "#C0392B"; 'dangerHover' = "#962D22"; 'successColor' = "#2ECC71"; 'warningColor' = "#F39C12"; 'infoColor' = "#4D9DE0"; 'selectedBorder' = "#4D9DE0"; 'selectedBackground' = "#E0EEFA"; 'hoverBackground' = "#EBF3FA"; 'secondaryBackground' = "#FFFFFF"; 'secondaryHover' = "#EBF3FA"}}
$script:embeddedConfigs['apps'] = @{'Browsers' = @{'brave' = @{'content' = "Brave"; 'winget' = "Brave.Brave"; 'description' = "Privacy-first browser with built-in ad blocker"}; 'firefox' = @{'content' = "Firefox"; 'winget' = "Mozilla.Firefox"; 'description' = "Privacy-focused web browser"}; 'tor' = @{'content' = "Tor Browser"; 'winget' = "TorProject.TorBrowser"; 'description' = "Anonymous web browsing via Tor network"}}; 'Security & Privacy' = @{'mullvad' = @{'content' = "Mullvad VPN"; 'winget' = "Mullvad.MullvadVPN"; 'description' = "Privacy-focused VPN service"}; 'protonvpn' = @{'content' = "ProtonVPN"; 'winget' = "Proton.ProtonVPN"; 'description' = "Secure VPN with no-logs policy"}; 'malwarebytes' = @{'content' = "Malwarebytes"; 'winget' = "Malwarebytes.Malwarebytes"; 'description' = "On-demand malware scanner and remover"}; 'veracrypt' = @{'content' = "VeraCrypt"; 'winget' = "IDRIX.VeraCrypt"; 'description' = "Disk encryption software for files and partitions"}}; 'Development' = @{'vscode' = @{'content' = "VS Code"; 'winget' = "Microsoft.VisualStudioCode"; 'description' = "Lightweight source code editor"}; 'github_desktop' = @{'content' = "GitHub Desktop"; 'winget' = "GitHub.GitHubDesktop"; 'description' = "GUI for Git and GitHub"}; 'docker' = @{'content' = "Docker Desktop"; 'winget' = "Docker.DockerDesktop"; 'description' = "Container platform for dev and test"}; 'dbeaver' = @{'content' = "DBeaver"; 'winget' = "DBeaver.DBeaver"; 'description' = "Universal database manager"}; 'bruno' = @{'content' = "Bruno"; 'winget' = "Bruno.Bruno"; 'description' = "Offline-first API testing client"}; 'git' = @{'content' = "Git"; 'winget' = "Git.Git"; 'description' = "Distributed version control system"}; 'nodejs' = @{'content' = "Node.js LTS"; 'winget' = "OpenJS.NodeJS.LTS"; 'description' = "JavaScript runtime built on Chrome's V8 engine"}; 'python' = @{'content' = "Python 3.12"; 'winget' = "Python.Python.3.12"; 'description' = "High-level programming language"}; 'windows_terminal' = @{'content' = "Windows Terminal"; 'winget' = "Microsoft.WindowsTerminal"; 'description' = "Modern terminal application for Windows"}; 'powershell' = @{'content' = "PowerShell 7"; 'winget' = "Microsoft.PowerShell"; 'description' = "Cross-platform shell and scripting language"}; 'ohmyposh' = @{'content' = "Oh My Posh"; 'winget' = "JanDeDobbeleer.OhMyPosh"; 'description' = "Prompt theme engine for any shell"}}; 'Media & Creative' = @{'gimp' = @{'content' = "GIMP"; 'winget' = "GIMP.GIMP"; 'description' = "Free and open-source image editor"}; 'krita' = @{'content' = "Krita"; 'winget' = "Krita.Krita"; 'description' = "Professional digital painting tool"}; 'inkscape' = @{'content' = "Inkscape"; 'winget' = "Inkscape.Inkscape"; 'description' = "Vector graphics editor"}; 'kdenlive' = @{'content' = "Kdenlive"; 'winget' = "KDE.Kdenlive"; 'description' = "Free and open-source video editor"}; 'obs' = @{'content' = "OBS Studio"; 'winget' = "OBSProject.OBSStudio"; 'description' = "Video recording and live streaming software"}; 'audacity' = @{'content' = "Audacity"; 'winget' = "Audacity.Audacity"; 'description' = "Multi-track audio recorder and editor"}; 'mpchc' = @{'content' = "MPC-HC"; 'winget' = "clsid2.mpc-hc"; 'description' = "Lightweight media player"}; 'vlc' = @{'content' = "VLC"; 'winget' = "VideoLAN.VLC"; 'description' = "Free and open source multimedia player"}; 'foobar2000' = @{'content' = "foobar2000"; 'winget' = "PeterPawlowski.foobar2000"; 'description' = "Advanced audio player"}; 'ytdlp' = @{'content' = "yt-dlp"; 'winget' = "yt-dlp.yt-dlp"; 'description' = "Command-line video downloader"}; 'sharex' = @{'content' = "ShareX"; 'winget' = "ShareX.ShareX"; 'description' = "Screen capture and file sharing tool"}}; 'Utilities' = @{'powertoys' = @{'content' = "PowerToys"; 'winget' = "Microsoft.PowerToys"; 'description' = "System utilities: FancyZones, PowerRename, Run, etc."}; 'everything' = @{'content' = "Everything"; 'winget' = "voidtools.Everything"; 'description' = "Lightning-fast file search engine"}; 'ditto' = @{'content' = "Ditto"; 'winget' = "Ditto.Ditto"; 'description' = "Clipboard manager with search history"}; 'hwinfo' = @{'content' = "HWiNFO64"; 'winget' = "REALiX.HWiNFO"; 'description' = "Comprehensive hardware monitoring tool"}; 'syncthing' = @{'content' = "Syncthing"; 'winget' = "Syncthing.Syncthing"; 'description' = "P2P file sync between devices"}; '7zip_zs' = @{'content' = "7-Zip ZS"; 'winget' = "mcmilk.7zip-zstd"; 'description' = "File archiver with Zstandard support"}; 'revo' = @{'content' = "Revo Uninstaller"; 'winget' = "RevoUninstaller.RevoUninstaller"; 'description' = "Advanced uninstaller tool"}; 'bitwarden' = @{'content' = "Bitwarden"; 'winget' = "Bitwarden.Bitwarden"; 'description' = "Open source password manager"}; 'motrix' = @{'content' = "Motrix"; 'winget' = "Motrix.Motrix"; 'description' = "Full-featured download manager"}; 'mobaxterm' = @{'content' = "MobaXterm"; 'winget' = "Mobatek.MobaXterm"; 'description' = "Enhanced terminal with X11 server"}}; 'Productivity' = @{'obsidian' = @{'content' = "Obsidian"; 'winget' = "Obsidian.Obsidian"; 'description' = "Local-first note-taking app with Markdown"}; 'sumatra' = @{'content' = "Sumatra PDF"; 'winget' = "SumatraPDF.SumatraPDF"; 'description' = "Lightweight PDF and ebook reader"}; 'notion' = @{'content' = "Notion"; 'winget' = "Notion.Notion"; 'description' = "All-in-one workspace for notes and tasks"}}}
$script:embeddedConfigs['dns'] = @{'Default_DHCP' = @{'description' = "Default DHCP (reset to auto)"}; 'Google' = @{'description' = "Google Public DNS"; 'ipv4' = @("8.8.8.8","8.8.4.4"); 'ipv6' = @("2001:4860:4860::8888","2001:4860:4860::8844")}; 'Cloudflare' = @{'description' = "Cloudflare DNS (1.1.1.1)"; 'ipv4' = @("1.1.1.1","1.0.0.1"); 'ipv6' = @("2606:4700:4700::1111","2606:4700:4700::1001")}; 'Cloudflare_Malware' = @{'description' = "Cloudflare Malware Protection"; 'ipv4' = @("1.1.1.2","1.0.0.2"); 'ipv6' = @("2606:4700:4700::1112","2606:4700:4700::1002")}; 'Cloudflare_Malware_Adult' = @{'description' = "Cloudflare Malware & Adult Protection"; 'ipv4' = @("1.1.1.3","1.0.0.3"); 'ipv6' = @("2606:4700:4700::1113","2606:4700:4700::1003")}; 'Open_DNS' = @{'description' = "Cisco OpenDNS"; 'ipv4' = @("208.67.222.222","208.67.220.220"); 'ipv6' = @("2620:119:35::35","2620:119:53::53")}; 'Quad9' = @{'description' = "Quad9 Security DNS"; 'ipv4' = @("9.9.9.9","149.112.112.112"); 'ipv6' = @("2620:fe::fe","2620:fe::9")}; 'AdGuard_Ads_Trackers' = @{'description' = "AdGuard DNS (Ads & Trackers)"; 'ipv4' = @("94.140.14.14","94.140.15.15"); 'ipv6' = @("2a10:50c0::ad1:ff","2a10:50c0::ad2:ff")}; 'AdGuard_Ads_Trackers_Malware_Adult' = @{'description' = "AdGuard DNS (Ads, Trackers, Malware, Adult)"; 'ipv4' = @("94.140.14.15","94.140.15.16"); 'ipv6' = @("2a10:50c0::bad1:ff","2a10:50c0::bad2:ff")}}
$script:embeddedConfigs['preferences'] = @{'bsod_verbose' = @{'content' = "BSoD Verbose Mode"; 'description' = "Show detailed error on Blue Screen of Death."; 'registry_on' = @(@{'path' = "HKLM:\SYSTEM\CurrentControlSet\Control\CrashControl"; 'name' = "DisplayParameters"; 'value' = 1}); 'registry_off' = @(@{'path' = "HKLM:\SYSTEM\CurrentControlSet\Control\CrashControl"; 'name' = "DisplayParameters"; 'value' = 0})}; 'login_acrylic' = @{'content' = "Logon Screen Acrylic Blur"; 'description' = "Enable acrylic blur on login screen."; 'registry_on' = @(@{'path' = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\System"; 'name' = "DisableAcrylicBackgroundOnLogon"; 'value' = 0}); 'registry_off' = @(@{'path' = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\System"; 'name' = "DisableAcrylicBackgroundOnLogon"; 'value' = 1})}; 'login_verbose' = @{'content' = "Logon Verbose Mode"; 'description' = "Display detailed startup/shutdown messages."; 'registry_on' = @(@{'path' = "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System"; 'name' = "VerboseStatus"; 'value' = 1}); 'registry_off' = @(@{'path' = "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System"; 'name' = "VerboseStatus"; 'value' = 0})}; 'mouse_acceleration' = @{'content' = "Mouse Acceleration"; 'description' = "Toggle mouse pointer precision."; 'registry_on' = @(@{'path' = "HKCU:\Control Panel\Mouse"; 'name' = "MouseSpeed"; 'value' = "1"},@{'path' = "HKCU:\Control Panel\Mouse"; 'name' = "MouseThreshold1"; 'value' = "6"},@{'path' = "HKCU:\Control Panel\Mouse"; 'name' = "MouseThreshold2"; 'value' = "10"}); 'registry_off' = @(@{'path' = "HKCU:\Control Panel\Mouse"; 'name' = "MouseSpeed"; 'value' = "0"},@{'path' = "HKCU:\Control Panel\Mouse"; 'name' = "MouseThreshold1"; 'value' = "0"},@{'path' = "HKCU:\Control Panel\Mouse"; 'name' = "MouseThreshold2"; 'value' = "0"})}; 'numlock_on' = @{'content' = "Num Lock on Startup"; 'description' = "Enable Num Lock automatically at startup."; 'registry_on' = @(@{'path' = "HKCU:\Control Panel\Keyboard"; 'name' = "InitialKeyboardIndicators"; 'value' = "2"}); 'registry_off' = @(@{'path' = "HKCU:\Control Panel\Keyboard"; 'name' = "InitialKeyboardIndicators"; 'value' = "0"})}; 'scrollbars_visible' = @{'content' = "Scrollbars Always Visible"; 'description' = "Force scrollbars to always be visible."; 'registry_on' = @(@{'path' = "HKCU:\Control Panel\Accessibility"; 'name' = "DynamicScrollbars"; 'value' = "0"}); 'registry_off' = @(@{'path' = "HKCU:\Control Panel\Accessibility"; 'name' = "DynamicScrollbars"; 'value' = "1"})}; 'bing_search' = @{'content' = "Start Menu Bing Search"; 'description' = "Disable Bing search suggestions."; 'registry_on' = @(@{'path' = "HKCU:\SOFTWARE\Policies\Microsoft\Windows\Explorer"; 'name' = "DisableSearchBoxSuggestions"; 'value' = 1}); 'registry_off' = @(@{'path' = "HKCU:\SOFTWARE\Policies\Microsoft\Windows\Explorer"; 'name' = "DisableSearchBoxSuggestions"; 'value' = 0})}; 'start_recommendations' = @{'content' = "Start Menu Recommendations"; 'description' = "Hide recommended section in Start menu."; 'registry_on' = @(@{'path' = "HKCU:\SOFTWARE\Policies\Microsoft\Windows\Explorer"; 'name' = "HideRecommendedSection"; 'value' = 1}); 'registry_off' = @(@{'path' = "HKCU:\SOFTWARE\Policies\Microsoft\Windows\Explorer"; 'name' = "HideRecommendedSection"; 'value' = 0})}; 'sticky_keys' = @{'content' = "Sticky Keys"; 'description' = "Disable Sticky Keys accessibility feature."; 'registry_on' = @(@{'path' = "HKCU:\Control Panel\Accessibility\StickyKeys"; 'name' = "Flags"; 'value' = "506"}); 'registry_off' = @(@{'path' = "HKCU:\Control Panel\Accessibility\StickyKeys"; 'name' = "Flags"; 'value' = "510"})}; 'taskbar_center' = @{'content' = "Taskbar Centered Icons"; 'description' = "Center taskbar icons (Windows 11 style)."; 'registry_on' = @(@{'path' = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced"; 'name' = "TaskbarAl"; 'value' = 1}); 'registry_off' = @(@{'path' = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced"; 'name' = "TaskbarAl"; 'value' = 0})}; 'taskbar_search' = @{'content' = "Taskbar Search Icon"; 'description' = "Show search icon only on taskbar."; 'registry_on' = @(@{'path' = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Search"; 'name' = "SearchboxTaskbarMode"; 'value' = 1}); 'registry_off' = @(@{'path' = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Search"; 'name' = "SearchboxTaskbarMode"; 'value' = 0})}; 'taskbar_taskview' = @{'content' = "Taskbar Task View Icon"; 'description' = "Show/hide Task View button."; 'registry_on' = @(@{'path' = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced"; 'name' = "ShowTaskViewButton"; 'value' = 1}); 'registry_off' = @(@{'path' = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced"; 'name' = "ShowTaskViewButton"; 'value' = 0})}; 'cross_device' = @{'content' = "Cross-Device Resume"; 'description' = "Allow cross-device activity sync."; 'registry_on' = @(@{'path' = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\CDP"; 'name' = "RomeSdk"; 'value' = 1}); 'registry_off' = @(@{'path' = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\CDP"; 'name' = "RomeSdk"; 'value' = 0})}; 'dark_theme' = @{'content' = "Dark Theme for Windows"; 'description' = "Enable Windows dark theme."; 'registry_on' = @(@{'path' = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Themes\Personalize"; 'name' = "AppsUseLightTheme"; 'value' = 0},@{'path' = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Themes\Personalize"; 'name' = "SystemUsesLightTheme"; 'value' = 0}); 'registry_off' = @(@{'path' = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Themes\Personalize"; 'name' = "AppsUseLightTheme"; 'value' = 1},@{'path' = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Themes\Personalize"; 'name' = "SystemUsesLightTheme"; 'value' = 1})}; 'file_extensions' = @{'content' = "File Explorer File Extensions"; 'description' = "Show file extensions."; 'registry_on' = @(@{'path' = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced"; 'name' = "HideFileExt"; 'value' = 0}); 'registry_off' = @(@{'path' = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced"; 'name' = "HideFileExt"; 'value' = 1})}; 'hidden_files' = @{'content' = "File Explorer Hidden Files"; 'description' = "Show hidden files and folders."; 'registry_on' = @(@{'path' = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced"; 'name' = "Hidden"; 'value' = 1}); 'registry_off' = @(@{'path' = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced"; 'name' = "Hidden"; 'value' = 2})}; 'mpo' = @{'content' = "Multiplane Overlay"; 'description' = "Enable/disable MPO. Disabling can fix GPU issues."; 'registry_on' = @(@{'path' = "HKLM:\SOFTWARE\Microsoft\Windows\Dwm"; 'name' = "OverlayTestMode"; 'value' = 5}); 'registry_off' = @(@{'path' = "HKLM:\SOFTWARE\Microsoft\Windows\Dwm"; 'name' = "OverlayTestMode"; 'value' = 0})}; 's0_standby' = @{'content' = "S0 Sleep Network Connectivity"; 'description' = "Keep network connectivity during Modern Standby."; 'registry_on' = @(@{'path' = "HKLM:\SYSTEM\CurrentControlSet\Control\Session Manager\Power"; 'name' = "NetworkConnectivityInStandby"; 'value' = 1}); 'registry_off' = @(@{'path' = "HKLM:\SYSTEM\CurrentControlSet\Control\Session Manager\Power"; 'name' = "NetworkConnectivityInStandby"; 'value' = 0})}; 's3_sleep' = @{'content' = "S3 Sleep"; 'description' = "Enable traditional S3 sleep state."; 'registry_on' = @(@{'path' = "HKLM:\SYSTEM\CurrentControlSet\Control\Power"; 'name' = "PlatformAoAcOverride"; 'value' = 0}); 'registry_off' = @(@{'path' = "HKLM:\SYSTEM\CurrentControlSet\Control\Power"; 'name' = "PlatformAoAcOverride"; 'value' = 1})}; 'battery_percent' = @{'content' = "System Tray Battery Percentage"; 'description' = "Show battery percentage in system tray."; 'registry_on' = @(@{'path' = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced"; 'name' = "ShowBatteryPercentage"; 'value' = 1}); 'registry_off' = @(@{'path' = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced"; 'name' = "ShowBatteryPercentage"; 'value' = 0})}}
$script:embeddedConfigs['cleaner'] = @{'Privacy' = @{'clear_recent_docs' = @{'content' = "Clear Recent Documents History"; 'description' = "Clears the list of recently accessed documents"; 'script' = "Remove-Item -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\RecentDocs' -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\ComDlg32\LastVisitedMRU' -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\ComDlg32\OpenSaveMRU' -Recurse -Force -ErrorAction SilentlyContinue"}; 'clear_run_history' = @{'content' = "Clear Start Menu Run History"; 'description' = "Clears the Run dialog history"; 'script' = "Remove-Item -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\RunMRU' -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\TypedPaths' -Recurse -Force -ErrorAction SilentlyContinue"}; 'clear_find_history' = @{'content' = "Clear Find File History"; 'description' = "Clears the Windows Search/Find history"; 'script' = "Remove-Item -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\FindComputerMRU' -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\Doc Find Spec MRU' -Recurse -Force -ErrorAction SilentlyContinue"}; 'clear_printers_history' = @{'content' = "Clear Printers, Computers and People Find History"; 'description' = "Clears network discovery history"; 'script' = "Remove-Item -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\PrinterPortsMRU' -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\ComputerDescriptions' -Recurse -Force -ErrorAction SilentlyContinue"}; 'clear_mspaint_history' = @{'content' = "Clear MS Paint Recent File History"; 'description' = "Clears the list of recently opened files in Paint"; 'script' = "Remove-Item -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Applets\Paint\Recent File List' -Recurse -Force -ErrorAction SilentlyContinue; Remove-ItemProperty -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Applets\Paint\MRU' -Name '*' -Force -ErrorAction SilentlyContinue"}; 'clear_wordpad_history' = @{'content' = "Clear MS Wordpad Recent File History"; 'description' = "Clears the list of recently opened files in Wordpad"; 'script' = "Remove-Item -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Applets\Wordpad\Recent File List' -Recurse -Force -ErrorAction SilentlyContinue"}; 'clear_regedit_history' = @{'content' = "Clear Regedit Last Opened Key History"; 'description' = "Clears the last visited keys in Registry Editor"; 'script' = "Remove-Item -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Applets\Regedit\Favorites' -Recurse -Force -ErrorAction SilentlyContinue; Remove-ItemProperty -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Applets\Regedit' -Name 'LastKey' -Force -ErrorAction SilentlyContinue"}; 'clear_common_dialog_history' = @{'content' = "Clear Common Dialog Open/Save Recent History"; 'description' = "Clears the Open/Save dialog history"; 'script' = "Remove-Item -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\ComDlg32\OpenSaveMRU' -Recurse -Force -ErrorAction SilentlyContinue"}; 'clear_common_dialog_folder' = @{'content' = "Clear Common Dialog Last Visited Folder History"; 'description' = "Clears the last visited folder in Open/Save dialogs"; 'script' = "Remove-Item -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\ComDlg32\LastVisitedPidlMRU' -Recurse -Force -ErrorAction SilentlyContinue; Remove-ItemProperty -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\ComDlg32' -Name 'LastVisitedFolder' -Force -ErrorAction SilentlyContinue"}; 'delete_start_usage_logs' = @{'content' = "Delete Start Menu Usage Logs"; 'description' = "Clears the Start Menu usage tracking data"; 'script' = "Remove-Item -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\StartPage\Apps' -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\StartPage\RecentApps' -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\StartPage\Favorites' -Recurse -Force -ErrorAction SilentlyContinue"}; 'clear_registry_traces' = @{'content' = "Clear Registry Usage Traces"; 'description' = "Cleans various MRU and usage trace keys from the registry"; 'script' = "Remove-Item -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\MountPoints2' -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\StreamMRU' -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\StuckRects2' -Recurse -Force -ErrorAction SilentlyContinue"}}; 'System' = @{'delete_prefetch' = @{'content' = "Delete Prefetch & System Logs"; 'description' = "Deletes Prefetch files and Windows log files"; 'script' = "Remove-Item -Path `"$env:WINDIR\Prefetch\*`" -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path `"$env:WINDIR\Logs\*`" -Recurse -Force -ErrorAction SilentlyContinue"}; 'empty_clipboard' = @{'content' = "Empty the Clipboard"; 'description' = "Clears the system clipboard"; 'script' = "$null = [System.Windows.Clipboard]::SetText([string]::Empty)"}; 'empty_recycle_bin' = @{'content' = "Empty the Recycle Bin"; 'description' = "Permanently deletes all items in the Recycle Bin"; 'script' = "Clear-RecycleBin -Force -ErrorAction SilentlyContinue"}; 'delete_temp_files' = @{'content' = "Delete Windows Temporary Files"; 'description' = "Deletes temporary files from user and system Temp folders"; 'script' = "Remove-Item -Path `"$env:TEMP\*`" -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path `"$env:WINDIR\Temp\*`" -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path `"$env:WINDIR\SoftwareDistribution\Download\*`" -Recurse -Force -ErrorAction SilentlyContinue"}; 'delete_crash_dumps' = @{'content' = "Delete Crash Memory Dump Files"; 'description' = "Deletes system crash dump and minidump files"; 'script' = "Remove-Item -Path `"$env:WINDIR\MEMORY.DMP`" -Force -ErrorAction SilentlyContinue; Remove-Item -Path `"$env:WINDIR\Minidump\*`" -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path `"$env:LOCALAPPDATA\CrashDumps\*`" -Recurse -Force -ErrorAction SilentlyContinue"}; 'delete_chkdsk_fragments' = @{'content' = "Delete Chkdsk Recovered File Fragments"; 'description' = "Deletes recovered file fragments from Chkdsk operations"; 'script' = "Remove-Item -Path `"$env:SystemDrive\FOUND.000\*`" -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path `"$env:SystemDrive\FOUND.001\*`" -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path `"$env:SystemDrive\FOUND.002\*`" -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path `"$env:SystemDrive\FOUND.003\*`" -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path `"$env:SystemDrive\FOUND.004\*`" -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path `"$env:SystemDrive\FOUND.005\*`" -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path `"$env:SystemDrive\FOUND.006\*`" -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path `"$env:SystemDrive\FOUND.007\*`" -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path `"$env:SystemDrive\FOUND.008\*`" -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item -Path `"$env:SystemDrive\FOUND.009\*`" -Recurse -Force -ErrorAction SilentlyContinue"}; 'delete_thumbnail_cache' = @{'content' = "Delete Thumbnail Cache"; 'description' = "Clears the Windows thumbnail cache for all users"; 'script' = "try { Stop-Process -Name 'explorer' -Force -ErrorAction SilentlyContinue; Remove-Item -Path `"$env:LOCALAPPDATA\Microsoft\Windows\Explorer\thumbcache_*.db`" -Force -ErrorAction SilentlyContinue; Remove-Item -Path `"$env:USERPROFILE\AppData\Local\Microsoft\Windows\Explorer\*.db`" -Force -ErrorAction SilentlyContinue } finally { Start-Process 'explorer.exe' -ErrorAction SilentlyContinue }"}}}
$script:embeddedConfigs['legacy'] = @(@{'key' = "rstrui"; 'content' = "System Restore"; 'command' = "rstrui.exe"; 'description' = "Create or restore system restore points"},@{'key' = "ncpa"; 'content' = "Network Information"; 'command' = "ncpa.cpl"; 'description' = "Manage network adapters and connections"},@{'key' = "wscui"; 'content' = "Security Center"; 'command' = "wscui.cpl"; 'description' = "View Windows Security Center status"},@{'key' = "sysdm"; 'content' = "System Properties"; 'command' = "sysdm.cpl"; 'description' = "View system info, performance, remote settings"},@{'key' = "msinfo32"; 'content' = "System Information"; 'command' = "msinfo32"; 'description' = "View detailed system hardware and software information"},@{'key' = "netstat"; 'content' = "TCP/IP Netstat"; 'command' = "cmd /c netstat -an && pause"; 'description' = "Display active network connections and listening ports"},@{'key' = "osk"; 'content' = "On Screen Keyboard"; 'command' = "osk"; 'description' = "Launch the on-screen keyboard"},@{'key' = "dfrgui"; 'content' = "Disk Defragmenter"; 'command' = "dfrgui"; 'description' = "Optimize and defragment disk drives"},@{'key' = "services"; 'content' = "Services"; 'command' = "services.msc"; 'description' = "Manage Windows services and their startup types"},@{'key' = "fsmgmt"; 'content' = "Shared Folders"; 'command' = "fsmgmt.msc"; 'description' = "Manage shared folders and connections"},@{'key' = "gpedit"; 'content' = "Group Policy"; 'command' = "gpedit.msc"; 'description' = "Edit Group Policy settings"},@{'key' = "optionalfeatures"; 'content' = "Add/Remove Windows Components"; 'command' = "OptionalFeatures"; 'description' = "Turn Windows features on or off"},@{'key' = "mrt"; 'content' = "Malicious Software Removal Tool"; 'command' = "mrt /Q"; 'description' = "Scan and remove malicious software"},@{'key' = "sdclt"; 'content' = "Windows Backup and Restore"; 'command' = "sdclt"; 'description' = "Backup and restore files or system image"},@{'key' = "taskschd"; 'content' = "Task Scheduler"; 'command' = "taskschd.msc"; 'description' = "Schedule automated tasks and triggers"},@{'key' = "chkdsk"; 'content' = "Check Disk"; 'command' = "cmd /c chkdsk && pause"; 'description' = "Check disk for file system errors"},@{'key' = "sfc"; 'content' = "System File Checker"; 'command' = "cmd /c sfc /scannow && pause"; 'description' = "Scan and repair protected system files"})
